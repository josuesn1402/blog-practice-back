# Ejemplos para usar en Postman

- [Ejemplos para usar en Postman](#ejemplos-para-usar-en-postman)
  - [Categoria](#categoria)
  - [Posts](#posts)
...
```json
{
  ...
  "urlImage": "https://images.unsplash.com/photo-1474511320723-9a56873867b5?auto=format&fit=crop&w=872&q=1000",
  "category": "Animales"
}
```
...
```json
{
  ...
  "urlImage": "https://images.unsplash.com/photo-1506619216599-9d16d0903dfd?auto=format&fit=crop&w=869&q=1000",
...
```json
{
  ...
  "urlImage": "https://images.unsplash.com/photo-1661956602868-6ae368943878?auto=format&fit=crop&w=870&q=1000",
  "category": "Oficina"
}
```
...
```json
{
  ...
  "urlImage": "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=870&q=1000",
  "category": "Ensalada"
}
```
...
```json
{
  ...
  "urlImage": "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&w=870&q=1000",
  "category": "Viajes"
}
```
...
```json
{
  ...
  "urlImage": "https://images.unsplash.com/photo-1488972685288-c3fd157d7c7a?auto=format&fit=crop&w=870&q=1000",
...
```json
{
  "content": "Los zorros son animales fascinantes y verlos en su entorno natural es una experiencia única. Excelente captura fotográfica.",
  "post": 1
}
```
...
```json
{
  "content": "El café es mi mejor compañero durante largas jornadas de trabajo. Me da energía y me ayuda a mantenerme concentrado. ¡Delicioso!",
  "post": 2
}
```
...
```json
{
  "content": "Me encanta el aroma del café y cómo su sabor me despierta por las mañanas. Una taza siempre es bienvenida en mi escritorio.",
  "post": 2
}
```
...
```json
{
  "content": "Una ensalada llena de colores y nutrientes. Ideal para mantener una alimentación saludable. ¡Me encanta!",
  "post": 3
}
```
...
```json
{
  "content": "¡Qué vista impresionante! Este paisaje me deja sin palabras. Me encantaría visitar este lugar algún día.",
  "post": 4
}
```
...
```json
{
  "content": "La fotografía captura la belleza de la naturaleza de una manera extraordinaria. Me transmite paz y serenidad.",
  "post": 4
}
```
...
```json
{
  "content": "La combinación de elementos clásicos y modernos en este diseño arquitectónico es simplemente fascinante. Me encanta.",
  "post": 5
}
```
...
```json
{
  "content": "El estilo minimalista transmite una sensación de calma y orden. Me gusta cómo cada elemento tiene su propósito y espacio definido.",
  "post": 6
}
```
...
```json
{
  "content": "La simplicidad y la elegancia van de la mano en este diseño minimalista. Me inspira a crear espacios más organizados en mi vida.",
  "post": 6
}
```
